...
select *From fn_payment 

select @Brief= isnull(clientid ,'')+' , '+isnull(clientName,'') +','+ convert(varchar(20),   payfund)+','+ convert(varchar(10),PaymentDate ,121   ) from fn_payment   where   Code=@Code
