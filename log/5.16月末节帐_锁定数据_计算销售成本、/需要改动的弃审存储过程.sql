...
select @fmonth=   chktime from wh_out  where code= @OutId  
...
begin  
 ...
 declare @IsChk bit,@IsClose bit,@ChkManId varchar(50),@BillId varchar(20), @ClientId varchar(20),@OutTypeId varchar(20),@WhId varchar(20),@InOut varchar(20)    
...
select @fmonth=   chktime from sl_retail  where code= @RetailId  
