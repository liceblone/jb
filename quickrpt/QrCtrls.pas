...
begin
  ...
  begin
   ...
   // this is new 02/09/04
    if Picture.Graphic is TBitmap then
    begin
      tempmap := TBitmap.Create;
      tempmap.Assign(Picture.Graphic);
      QRPrinter.Canvas.StretchDraw(Dest, tempmap);
      tempmap.Free;
    end
    else
    begin // new actions for Metafile case
      ...
      begin
        ...
        tempMeta.Assign(Picture.Graphic);
        QRPrinter.Canvas.StretchDraw(Dest, tempMeta);
        tempMeta.Free;
      end
      else
      begin
...
begin
    ...
    FillChar(Range, SizeOf(TFormatRange), 0);
    // this is safe because we don't actually render
    ...
    // twips 
    Range.rc := Rect(0, 0, QRPrinter.XPos(Size.Width) * 1440 div LogX,
                                       QRPrinter.YPos(Size.Height) * 1440 div LogY);
    ...
    begin
      ...
      begin
        Range.rc.Bottom := Range.rc.Bottom + (QRPrinter.YPos(50) * 1440 div LogY);
    ...
    newHeight := (size.Height + Extraheight)*QRPrinter.YFactor;
