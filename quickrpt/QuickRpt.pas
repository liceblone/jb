...
begin
  ...
  begin
       ...
       parentband := TQRCustomband(fparent);
       parentcontrol := nil;
       fbackcolor :=  parentband.Color;
...
begin
      ...
      begin
          if (Controls[I] is TQRDBText) or (Controls[I] is TQRDBImage)
               or (Controls[I] is TQRMemo) or (Controls[I] is TQRDBRichText) then
          begin
             ...
             begin
                if Controls[I] is TQRMemo then
                        ...
                        TQRDBRichText(Controls[I]).GetExpandedHeight( theight )
                else
...
begin
  ...
  begin
          ...
          ih := QRPrinter.YPos(TQRImage(FBackgroundcontrol).size.Height);
          iw := QRPrinter.YPos(TQRImage(FBackgroundcontrol).size.Width);
          QRprinter.Canvas.StretchDraw( Rect(x, y, iw, ih ),TQRImage(FBackgroundcontrol).Picture.Graphic);
          if Exporting then
