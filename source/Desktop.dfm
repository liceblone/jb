object DesktopFrm: TDesktopFrm
  ...
  object ActionList1: TActionList
    ...
    object ActOpenBillEx: TAction
      Category = 'Frm'
      Caption = 'OpenBillEx'
      OnExecute = ActOpenBillExExecute
    end
    object ActAnalysEX: TAction
      Category = 'Frm'
      Caption = 'ActAnalysEX'
      OnExecute = ActAnalysEXExecute
    end
    object ActOpenCostSystem: TAction
      Category = 'Frm'
      Caption = 'OpenCostSystem'
      OnExecute = ActOpenCostSystemExecute
    end
  end
