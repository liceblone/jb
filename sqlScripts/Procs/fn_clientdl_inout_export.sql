...
AS                                                           
       ...
       /*                    
       exec fn_clientdl_inout_export 'HZ003239%','2017-01-27 00:00:00','2017-02-26 00:00:00','往来%','全部%','日期%'          
       exec fn_clientdl_inout 'HZ003239','2017-01-27 00:00:00','2017-02-26 00:00:00','往来','全部','日期'          
       exec [fn_clientdl_inout_export] 'HZ003239','2017-01-27 00:00:00','2017-02-26 00:00:00','往来','全部','日期'          
       exec fn_clientdl_inout 'HZ002389','2017-01-27 00:00:00','2017-02-26 00:00:00','往来','全部','日期'          
       exec [fn_clientdl_inout_export] 'HZ003719','2017-8-20 00:00:00','2017-8-30 00:00:00','往来','全部','日期'                                       
...
if   @BeginDate <  DATEADD(d,-31*3,GETDATE() )           
 ...
 'clBlack' as FntClr,'此前结余' as Brief  ,'' partno          
...
union all                                                                                    
 ...
 'clBlack','其它'  , '' PartNo,'' as Brand ,'' as Pack, '' as RsSurfix ,null as qty,null  as price, null  as amt,            
...
union all                                                                                    
 ...
 (case IsChk when 1 then 'clBlack' else 'clRed' end),'异地调配出库'            
...
union all                                     
  select null as   islock,0,1,0,m.IsOutBill,22,d.dlid,m.Code,m.billtime, m.OutDate , m.Code,                                                                
 'clBlack',   case when m.OutTypeId='X09' then '异地调配出库' else '赠品出库' end          
...
union all                                                                                    
select null as   islock,1,1,9,-1,-1,null,null,null,null,null,'clBlack','合    计', '' as PartNo, '' as Brand ,'' as Pack,'' as RsSurfix,null Qty, null Price, null as amt,                                                              
       null,null,                                                                                    
